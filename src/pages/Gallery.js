...
import CANVAS_39 from './../images/canvas_39.png';
import GS_1 from './../images/GS_1.png'
import GS_4 from './../images/GS_4.png'
import GS_7 from './../images/GS_7.png'
import CIRCLE_12 from './../images/circle_12.png';
    ...
    return (
      <div className="img-column">
        ...
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_37} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_38} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_39} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_25} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_26} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_30} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_17} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_19} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_20} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_13} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_14} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_15} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_5} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_6} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_7} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CIRCLE_12} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS_2} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CANVAS} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={GS_1} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={GS_4} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={GS_7} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={CACTUS} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={HATT} alt="img" />
        </div>
        <div className="img-card">
        ...
        <div className="img-card">
          <img loading="lazy" className="images" src={NFT_BODY} alt="img" />
        </div>
        <div className="img-card">
          <img loading="lazy" className="images" src={SAMURAI} alt="img" />
        </div>
